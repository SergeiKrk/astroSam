...
const Subscribe = () => {
	...
	useEffect(() => {
		...
		}, 17000) // Открыть tooltip через каждые 15 секунд (5 секунд ожидания + 10 секунд видимости)
	...
	return (
		<div
			className={`tooltip tooltip-left tooltip-accent flex text-24 items-center justify-center ${tooltipOpen ? 'tooltip-open' : ''}`}
